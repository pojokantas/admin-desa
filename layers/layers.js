...
lyr_dukuh_somopuro_1.set('fieldLabels', {'fid_1': 'no label', 'desa_kel': 'inline label - visible with data', 'RT1': 'inline label - visible with data', 'RW1': 'inline label - visible with data', 'DK_KP': 'inline label - visible with data', 'WADMKC_12': 'inline label - visible with data', });
